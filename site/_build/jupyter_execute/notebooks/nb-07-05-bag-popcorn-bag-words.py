...
clean_review_word = KaggleWord2VecUtility.review_to_wordlist         ( train["review"][0], True )
clean_review_sentence = KaggleWord2VecUtility.review_to_wordlist         ( train["review"][0], True )
